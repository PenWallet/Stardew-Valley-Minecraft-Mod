...
public class ShippingChestBlock extends ContainerBlock
{
    public ShippingChestBlock()
    {
    ...
    public TileEntity createNewTileEntity(IBlockReader worldIn) {
        return new TileEntitySellingChest();
    }
    ...
    public void onReplaced(BlockState state, World world, BlockPos blockPos, BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (tileentity instanceof TileEntitySellingChest) {
                TileEntitySellingChest tileEntityInventoryBasic = (TileEntitySellingChest)tileentity;
