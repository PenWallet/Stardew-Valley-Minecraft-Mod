 ...
 */
public class TileEntitySellingChest extends TileEntity implements INamedContainerProvider {
    public static final int NUMBER_OF_SLOTS = 1;

    private final ChestContents chestContents; // holds the ItemStacks in the Chest

    public TileEntitySellingChest()
    {
        super(TileEntityList.shippingChestTile);
    ...
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent("container.stardewmod.shippingchest");
    }
    ...
    public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        return ShippingChestContainer.createContainerServerSide(windowID, playerInventory, chestContents);
    }
}