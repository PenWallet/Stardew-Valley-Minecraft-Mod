package com.lethalmap.stardewmod.common.gui;
...
public class CustomInventoryScreen extends DisplayEffectsScreen<PlayerContainer> implements IRecipeShownListener {
    ...
    protected void init() {
        if (this.minecraft.playerController.isInCreativeMode()) {
            ...
            this.addButton(new ImageButton(this.guiLeft + 151, this.height / 2 - 79, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEXTURE, (p_214086_1_) -> {
                this.recipeBookGui.func_201518_a(this.widthTooNarrow);
                this.recipeBookGui.toggleVisibility();
                this.guiLeft = this.recipeBookGui.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
                ((ImageButton)p_214086_1_).setPosition(this.guiLeft + 151, this.height / 2 - 79);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.minecraft.getTextureManager().bindTexture(CUSTOM_INVENTORY);
        int i = this.guiLeft;
        int j = this.guiTop;
