...
public class OreGeneration {
    ...
    public static void setupOreGeneration() {
        for (Biome biome : ForgeRegistries.BIOMES) {
            ...
            biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockList.emeraldore.getDefaultState(), 5)).func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(20, 0, 0, 55))));
